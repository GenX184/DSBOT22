    ...
    switch (code) {
        ...
        case 'crystals':     
                        ...
                        if(rank > 0)
                        {
                            ...
                            if(rank === 1) B= B +'<Your Rank <'+rank+'> \t\t\t<Crystals = '+ValueFormater+'>```'; 
                            if(rank === 2) B= B +'<Your Rank <'+rank+'> \t\t\t<Crystals = '+ValueFormater+'>```'; 
                            if(rank === 3) B= B +'<Your Rank <'+rank+'> \t\t\t<Crystals = '+ValueFormater+'>```'; 
                            if(rank > 3) B= B +'<Your Rank <'+rank+'> \t\t\t<Crystals = '+ValueFormater+'>```'; 
                        }
                        else B = B + '```';
