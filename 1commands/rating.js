...
module.exports.run = async (bot,message,args) => {
    ...
    let ranks = JSON.parse(fs.readFileSync("AGameBase/Rank.json","utf8"));
    ...
    user = args[0]
    if(!user) return message.channel.send(" :exclamation: |  **Make sure you don't leave more than one space after $rating ** \n:exclamation: |  ***Usage :*** `$rating nickname`")
